...
iframe.srcdoc = `${editorHtml.getValue()}<style>${editorCss.getValue()}</style> <script src="//cdn.jsdelivr.net/npm/eruda"></script><script>eruda.init({tool : ["console","elements"], default : {displaySize: 100, theme : "Material Darker"}});</script><script>${editorJs.getValue()}</script>`;
SessionsKey();
});
function ForPcOn(){
